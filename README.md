...
月白历是一个轻量的 macOS 菜单栏农历日历。它显示公历日期、农历、星期和可选时间；点开后可以查看月历、农历日期、系统节假日订阅，并快速判断某一天距离当前日期还有多久。
...
最新版本见 [GitHub Releases](https://github.com/guozhixin88/yuebaili/releases)。
...
项目维护背景、产品决策和会话索引见 [docs/MAINTENANCE.md](./docs/MAINTENANCE.md)。
